import { ShoppingCart, Cloud, Rocket } from 'lucide-react';
import './Projects.css';
...
const projects = [
  {
    ...
    title: 'Tix Id',
    description:
      'Aplikasi pemesanan tiket online yang memungkinkan pengguna untuk mencari dan memesan tiket acara, konser, atau transportasi dengan mudah. Dibangun menggunakan PHP dan Laravel dengan desain responsif menggunakan Bootstrap.',
    tags: ['PHP', 'Laravel', 'Bootstrap'],
    icon: ShoppingCart,
    image: '/src/assets/Screenshot 2026-04-03 220126.png',
    color: '#6c63ff',
          ...
          {projects.map((project) => (
            <div key={project.id} className="project-card">
              <div
                ...
                style={!project.image ? { background: `linear-gradient(135deg, ${project.color}22, ${project.color}44)` } : {}}
              >
                {project.comingSoon ? (
                  <div className="coming-soon-overlay">
                    <Rocket size={36} color="var(--primary)" strokeWidth={1.5} />
              ...
              <div className="project-body">
                ...
                <div className="project-links">
                  ...
                  <a href={project.demo} className="project-link link-demo" target="_blank" rel="noopener noreferrer">
